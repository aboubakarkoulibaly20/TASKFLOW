...
class FileRepository {
    ...
    public function process($data = []) {
        ...
        $file_path = base_path() . "/storage/temp/" . $data["file_directory"] . "/" . $data["file_filename"];
        $old_dir_path = base_path() . "/storage/temp/" . $data["file_directory"];
        $new_dir_path = base_path() . "/storage/files/" . $data["file_directory"];
