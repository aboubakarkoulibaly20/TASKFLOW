...
class CloneInvoiceRepository {
    ...
    public function clone ($data = []) {
        ...
        $new_invoice->bill_system = 'no';
        $new_invoice->bill_viewed_by_client = 'no';
        $new_invoice->bill_publishing_type = 'instant';
        $new_invoice->bill_publishing_scheduled_date = null;
        $new_invoice->bill_publishing_scheduled_status = '';
        $new_invoice->bill_publishing_scheduled_log = '';
