...
class Menus {
    ...
    private function validateMenu($menu = [], $module_name = '') {
        ...
        try {
            ...
            //set menu visibility
            $menu['visible'] = $this->setMenuVisibility($module_name, $menu);
            ...
            if ($menu['type'] == 'dropdown') {
                ...
                foreach ($menu['data'] as $key => $submenu) {
                    ...
                    //set menu visibility
                    $menu['data'][$key]['visible'] = $this->setMenuVisibility($module_name, $menu['data'][$key]);
     ...
     * @return bool
     *-----------------------------------------------------------------------------------*/
    private function setMenuVisibility($module_name, $menu = []) {
