        ...
        try {
            ...
            foreach ($modules as $module) {
                ...
                if (file_exists($module_css)) {
                    ...
                    $css = '<link rel="stylesheet" href="/modules/' . strtolower($module_name) . '/resources/assets/css/module.css">';
                } else {
                ...
                if (file_exists($module_custom_css)) {
                    ...
                    $custom_css = '<link rel="stylesheet" href="/modules/' . strtolower($module_name) . '/resources/assets/css/custom.css">';
                } else {
                ...
                if (file_exists($module_js)) {
                    ...
                    $js = '<script src="/modules/' . strtolower($module_name) . '/resources/assets/js/module.js"></script>';
                } else {
