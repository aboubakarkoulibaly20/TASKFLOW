        ...
        return [
            ...
            [
                ...
                'submenus' => [
                    [
                        'id' => 'list_clients',
                        'label' => get_label('list_clients', 'Liste clients'),
                        'url' => url('clients'),
                        'class' => 'menu-item' . (Request::is('clients') ? ' active' : ''),
                        'show' => $user->can('manage_clients') ? 1 : 0
                    ],
                    [
                        'id' => 'situations_clients',
                        'label' => get_label('situations_clients', 'Situations clients'),
                        'url' => url('situations'),
                        'class' => 'menu-item' . (Request::is('situations') || Request::is('situations/*') ? ' active' : ''),
                        'show' => ($user->can('manage_situationsfiscales') || $user->can('manage_situationssociales')) ? 1 : 0
                    ],
                ],
            ],
            [
            ...
            [
                'id' => 'etatsfinanciers',
                'label' => get_label('etatsfinanciers', 'Etats Financiers'),
                'url' => url('etatsfinanciers'),
                'icon' => 'bx bx-tab',
                'class' => 'menu-item' . (Request::is('etatsfinanciers') || Request::is('etatsfinanciers/*') ? ' active' : ''),
                'show' => $user->can('manage_etatsfinanciers') ? 1 : 0,
                'category' => 'team',
            ],
            [
                'id' => 'formations',
                'label' => get_label('trainings', 'Formations'),
                'url' => url('formations/registrations'),
                'icon' => 'bx bx-bookmark-alt',
                'class' => 'menu-item' . (Request::is('formations') || Request::is('formations/*') ? ' active' : ''),
                'show' => $user->can('manage_formations') ? 1 : 0,
                'category' => 'team',
            ],
            [
                'id' => 'users',
            ...
            [
                ...
                'submenus' => [
                    ...
                    [
                        'id' => 'expense_types',
                        'label' => get_label('expense_type', 'Expense types'),
