...
return [
    ...
    */
    ...
    'permissions' => [
        ...
        'Etats Financiers' =>  array('manage_etatsfinanciers', 'delete_etatsfinanciers'),
        'Situations fiscales' =>  array('create_situationsfiscales',  'manage_situationsfiscales', 'edit_situationsfiscales','delete_situationsfiscales'),
        'Situations sociales' =>  array('create_situationssociales', 'manage_situationssociales', 'edit_situationssociales', 'delete_situationssociales'),
        'Meetings' =>  array('create_meetings', 'manage_meetings', 'edit_meetings', 'delete_meetings'),
        'Formations' =>  array('create_formations', 'manage_formations', 'edit_formations', 'delete_formations'),
