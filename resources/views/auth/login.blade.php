            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="app-brand justify-content-center">
                        <a href="{{ url('/') }}" class="app-brand-link gap-2">
                            <span class="app-brand-logo demo">
                                <img src="{{asset('/storage/' . $general_settings['full_logo'])}}" width="300px" alt="" />
                            </span>
                        </a>
                    </div>
                    <!-- /Logo -->
                    ...
                    <form id="formAuthentication" class="mb-3 form-submit-event" action="{{url('users/authenticate')}}" method="POST">
                        ...
                        @if (config('constants.ALLOW_MODIFICATION') === 0)
                        <div class="mb-3">
                            <button class="btn btn-success d-grid w-100 admin-login" type="button">Connexion Admin</button>
                        </div>
                        <div class="mb-3">
                            <button class="btn btn-info d-grid w-100 member-login" type="button">Connexion Employé</button>
                        </div>
                        <div class="mb-3">
                            <button class="btn btn-warning d-grid w-100 client-login" type="button">Connexion Client</button>
                        </div>
                        @endif
                    </form>
                </div>
