...
<div class="container-fluid container-p-y">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="mb-0">Ajouter une inscription</h3>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('formations.registrations.store') }}" method="post">
                @csrf
                <div class="row g-3">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="number" min="1" name="nombre_tickets" class="form-control" value="{{ old('nombre_tickets') }}">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="text" name="devise" class="form-control" value="{{ old('devise') }}" placeholder="ex: EUR, USD">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="methode_paiement" class="form-control" value="{{ old('methode_paiement') }}">
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="commentaire_admin" class="form-control" rows="3">{{ old('commentaire_admin') }}</textarea>
                    </div>
                </div>
