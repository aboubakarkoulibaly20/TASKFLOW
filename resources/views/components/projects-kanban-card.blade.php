<div class="kanban-board d-flex bg-body gap-3 overflow-auto p-3">
    ...
    <div class="kanban-column card" data-status-id="{{ $status->id }}">
        <div class="kanban-column-header card-header bg-label-{{ $status->color ?? 'secondary' }} d-flex justify-content-between align-items-center p-3">
            <div class="fw-semibold">
                {{ $status->title }}
            </div>
            <div class="column-count badge text-{{ $status->color ?? 'secondary' }} bg-white">
            ...
            <div class="kanban-card card mb-3" data-card-id="{{ $project->id }}">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <span class="badge bg-{{ $tag->color ?? 'secondary' }} mt-1">{{ $tag->title }}</span>
                        @endforeach
                    </div>
                    @endif
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        @if($project->priority)
                        <span class="badge bg-label-{{ $project->priority->color ?? 'secondary' }}">
