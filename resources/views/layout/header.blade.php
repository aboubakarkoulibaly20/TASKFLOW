<head>
    ...
    <script src="{{ asset('vendor/js/vendor.header.js?v=' . config('system.versioning')) }}"></script>
    <!--BOOTSTRAP-->
    ...
    <link rel="stylesheet" href="{{ asset('vendor/js/bootstrap-timepicker/bootstrap-timepicker.css?v=' . config('system.versioning')) }}">

    <!--ICONS-->
    <link rel="stylesheet" href="{{ asset('vendor/fonts/growcrm-icons/styles.css?v=' . config('system.versioning')) }}">
    <link rel="stylesheet" href="{{ asset('vendor/fonts/phosphor-icons/regular/style.css?v=' . config('system.versioning')) }}">
    ...
    @if(config('visibility.external_view_use_default_theme'))
        <link href="{{ asset('themes/default/css/style.css?v=' . config('system.settings_system_javascript_versioning')) }}"
            rel="stylesheet">
    @else
        @if(auth()->check()) 
            <link
                href="{{ asset('themes/' . auth()->user()->pref_theme . '/css/style.css?v=' . config('system.settings_system_javascript_versioning')) }}"
                rel="stylesheet">
        @else
            <link href="{{ asset('/themes/midnight/css/style.css') }}" rel="stylesheet">
        @endif
    @endif
    ...
    <!--PRINTING CSS-->
    <link href="{{ asset('css/print.css?v=' . config('system.versioning')) }}" rel="stylesheet">
    ...
    <link rel="stylesheet" href="{{ asset('js/codemirror/codemirror.min.css?v=' . config('system.versioning')) }}">
    <link rel="stylesheet" href="{{ asset('js/codemirror/darcula.min.css?v=' . config('system.versioning')) }}">
