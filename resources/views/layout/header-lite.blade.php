<head>
    ...
    <script src="{{ asset('vendor/js/vendor-lite.header.js?v=' . config('system.versioning')) }}"></script>
    ...
    <!--VENDORS CSS-->
    <link rel="stylesheet" href="{{ asset('vendor/css/vendor-lite.css?v=' . config('system.versioning')) }}">

    <!--ICONS-->

    <!--THEME STYLE (always use the default theme)-->
    <link href="{{ asset('themes/default/css/style.css?v=' . config('system.versioning')) }}" rel="stylesheet">
