            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-start align-items-sm-center gap-4">
                        ...
                        <h4 class="card-header fw-bold">{{ $client->company }}</h4> <?= $client->status == 1 ? '<span class="badge bg-success">' . get_label('active', 'Active') . '</span>' : '<span class="badge bg-danger">' . get_label('deactive', 'Deactive') . '</span>' ?>
                    </div>
                </div>
                <hr class="my-0" />
                <div class="card-body">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane fade active show" id="navs-top-projects" role="tabpanel">
                <div class="d-flex justify-content-between">
                    <h4 class="fw-bold mx-4 mt-4">{{$client->company}} - <?= get_label('projects', 'Projects') ?></h4>
                </div>
            ...
            <div class="tab-pane fade {{!$auth_user->can('manage_projects')?'active show':''}}" id="navs-top-tasks" role="tabpanel">
                <div class="d-flex justify-content-between">
                    <h4 class="fw-bold mx-4 mt-4">{{$client->company}} - <?= get_label('tasks', 'Tasks') ?></h4>
                </div>
                @if ($tasks > 0)
                <?php
                $id = 'client_' . $client->id;
