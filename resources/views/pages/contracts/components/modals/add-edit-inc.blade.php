...
<!--doc_unique_id-->
<div class="form-group row">
    <label class="col-sm-12 col-lg-3 text-left control-label col-form-label">@lang('lang.contract_id')</label>
    <div class="col-sm-12 col-lg-9">
        <div class="input-group input-group-sm">
            <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1">CONT#</span>
            </div>
            <input type="text" class="form-control form-control-sm" id="doc_unique_id" name="doc_unique_id" value="{{ $contract->doc_unique_id ?? $next_id ?? '' }}" readonly>
        </div>
    </div>
</div>
...
<div class="form-group row">
    <label
        class="col-sm-12 col-lg-3 text-left control-label col-form-label  required">{{ cleanLang(__('Type de contrat')) }}*</label>
    <div class="col-sm-12 col-lg-9">
...
<!--contract_start_date-->
<div class="form-group row">
    <label class="col-sm-12 col-lg-3 text-left control-label col-form-label required">@lang('lang.start_date')</label>
    <div class="col-sm-12 col-lg-9">
...
<!--contract_end_date-->
<div class="form-group row">
    <label class="col-sm-12 col-lg-3 text-left control-label col-form-label">@lang('lang.end_date')</label>
    <div class="col-sm-12 col-lg-9">
...
<!--doc_value-->
<div class="form-group row">
    <label class="col-sm-12 col-lg-3 text-left control-label col-form-label">@lang('Valeur du contrat')</label>
    <div class="col-sm-12 col-lg-9">
