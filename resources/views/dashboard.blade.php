...
@endif
                        ...
                        <ul class="p-0 m-0">
                            ...
                            <li class="d-flex mb-4 pb-1">
                                <div class="avatar flex-shrink-0 me-3">
                                    <span class="avatar-initial rounded bg-label-primary"><i class="bx bx-briefcase-alt-2 text-{{ $status->color ?? 'secondary' }}"></i></span>
                                </div>
                ...
                <div class="card overflow-hidden mb-4 statisticsDiv">
                    ...
                    <div class="card-body" id="task-statistics">
                        ...
                        <ul class="p-0 m-0">
                            ...
                            <li class="d-flex mb-4 pb-1">
                                <div class="avatar flex-shrink-0 me-3">
                                    <span class="avatar-initial rounded bg-label-primary"><i class="bx bx-task text-{{ $status->color ?? 'secondary' }}"></i></span>
                                </div>
                                <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                                    <div class="me-2">
    ...
    <div class="nav-align-top {{$auth_user->can('manage_projects') || $auth_user->can('manage_tasks')?' mt-4':''}}">
        <ul class="nav nav-tabs" role="tablist">
