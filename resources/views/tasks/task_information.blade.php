                            ...
                            <div class="row">
                                ...
                                <div class="col-md-{{$task->note ? '7' : '6'}} mb-3">
                                    ...
                                    <div class="d-flex align-items-center">
                                        <select class="form-select form-select-sm select-bg-label-{{ $task->status->color ?? 'secondary' }}" id="statusSelect" data-id="{{ $task->id }}" data-original-status-id="{{ $task->status->id }}" data-original-color-class="select-bg-label-{{ $task->status->color ?? 'secondary' }}" data-type="task">
