...
return [
    ...
    'a_project_is_required_for_billable_expenses' => "A Diligence is required (for billable expenses)",
    ...
    'active_projects' => "Active Diligences",
    ...
    'add_project' => "Create A New Diligence",
    ...
    'all_leads' => "All leads",
    'all_projects' => "All Diligences",
    'all_setting_permissions_when_adding_project' => "Allow user to set client and staff permissions when adding a new diligence",
    'all_tasks' => "All Tasks",
    ...
    'archive_project' => "Archive Diligence",
    'archive_task' => "Archive Task",
    'archive' => "Archive",
    'archived' => "Archived",
    'archives_leads' => "Archived Sales Activity",
    'archives_projects' => "Archived Diligences",
    ...
    'assign_projects' => "Assign Diligences",
    ...
    'client_project_permissions' => "Client's Diligence Permissions",
    ...
    'clone_project' => "Clone Diligence",
    'clone_proposal' => "Clone Quote",
    ...
    'completed_projects' => "Completed Diligences",
    ...
    'you_created_this_project' => "You created this diligence",
    'you_created_this_proposal' => "You created this quote",
    ...
    'add_project_splah_title' => "Who is this diligence for?",
    ...
    'import_projects' => "Import Diligences",
    ...
    'no_tasks_assigned_to_you' => "There are no tasks assigned to you on the selected diligence",
    ...
    'you_are_now_not_assigned_to_this_project' => "You are not assigned to this diligence",
    ...
    'create_a_new_project' => "Create a new diligence",
    'create_a_project_template' => "Create A Diligence Template",
    'create_from_a_template' => "Create from a template",
    'delete_template' => "Delete Template",
    'description_and_details' => "Description & Details",
    'discount_type' => "Discount Type",
    'edit_project_template' => "Edit Diligence Template",
    'edit_template' => "Edit Template",
    'is_required' => "is required",
    'project_templates' => "Diligence Templates",
    'project_teplate' => "Diligence Template",
    ...
    'project_reminder' => "Diligence Reminder",
    ...
    'invalid_permissions_for_project' => "You do not have permissions for this diligence",
    ...
    'project_cover_images_feature' => "Diligence Cover Images",
    'projects_assigned_auto' => "Users are assigned automatically from the diligence's category users",
    'projects_user_permission' => "Diligence Team Permissions",
    ...
    'show_project_categories_main_menu' => "Show Diligence Categories In Main Menu",
    ...
    'confirm_accept_proposal' => "Please confirm that you want to accept this quote",
    'confirm_decline_contract' => "Please confirm that you want to decline this Contract",
    'confirm_decline_proposal' => "Please confirm that you want to decline this quote",
    'content' => "Content",
    ...
    'cover' => "Cover",
    'decline_proposal' => "Decline Quote",
    ...
    'event_accepted_proposal' => "Accepted a quote",
    'event_created_contract' => "Created a new contract",
    'event_created_proposal' => "Created a new quote",
    'event_declined_contract' => "Declined a contract",
    'event_declined_proposal' => "Declined a quote",
    ...
    'next_id_number_proposal' => "Next Quote ID",
    'none_blank' => "None (blank)",
    'open_ended' => "Open Ended",
    'prepared_by' => "Prepared By",
    'print_contract' => "Print Contract",
    'print_proposal' => "Print Quote",
    'proposal' => "Quote",
    'proposal_date' => "Quote Date",
    'proposal_id' => "Quote ID",
    'proposal_not_found' => "Quote not found",
    'proposal_target' => "Quote Target",
    'proposal_title' => "Quote Title",
    'proposal_url' => "Quote URL",
    'proposal_valid_to_date_error' => "Valid to date cannot be before the quote date",
    'proposals' => "Quotes",
    'proposed_to' => "Quoted To",
    'publish_document' => "Publish Document",
    'service_provider' => "Service Provider",
    'show_contract_after_its_created' => "Show contract after its been created",
    'show_proposal_after_its_created' => "Show quote after its been created",
    'target' => "Target",
    ...
    'template_lang_new_proposal' => "New Quote",
    'template_lang_proposal_accepted' => "Quote Accepted",
    'template_lang_proposal_declined' => "Quote Decline",
    'template_lang_proposal_revised' => "Quote Revised",
    ...
    'apply_default_automation_project' => "Apply default automation settings. These can be changed, once the diligence has been created",
    'automation' => "Automation",
    'automation' => "Automation",
    'automation_assign_project' => "Automatically assign the diligence",
    'automation_create_invoice' => "Create a new invoice",
    'automation_create_project' => "Create a new diligence",
    'automation_create_project_status' => "Diligence status",
    ...
    'automation_email_client_project_info' => "Send a 'New Diligence Created' email",
    ...
    'automation_generate_invoice_info' => "Invoices will be generated from existing estimates for this diligence",
    'automation_invoice_due_date' => "Invoice due date (days)",
    'automation_invoice_project' => "Automatically create invoices for the diligence",
    ...
    'project_automation' => "Diligence Automation",
    'project_automation_default' => "Diligence Automation (default status)",
    'project_automation_default_info' => "If enabled, this automation will be available when creating a new diligence",
    'project_automation_info_1' => "When a diligence is marked as 'completed', do the following",
    'project_automation_info_3' => "These are the default settings, but you can still change them on a diligence by diligence basis",
    ...
    'from_project' => "from diligence", //context - see above
    ...
    'affiliate' => "Affiliate",
    'project_automation_info_2' => "This applies to diligences that are manually marked as completed",
    ...
    'project_invoices' => "Diligence Invoices",
    'monthly_revenue' => "Monthly Revenue",
    'yearly_revenue' => "Yearly Revenue",
    'project_category_invoices' => "Diligence Category Invoices",
    'overview' => "Overview",
    ...
    'export_projects' => "Export Diligences",
    'export_tasks' => "Export Tasks",
    'export_leads' => "Export Leads",
    'export_contracts' => "Export Contracts",
    'export_proposals' => "Export Quotes",
    'estimated_cost' => "Estimated Cost",
    'visibility' => "Visibility",
    'cloning_projects' => "Cloning Diligences",
    ...
    'reset_color_on_project_milestone' => "Update color on existing diligence milestone",
    'unpaid_invoices' => "Invoices Balance",
    'open_tickets' => "Open Tickets",
    'closed_tickets' => "Closed Tickets",
    'accepted_estimates' => "Accepted Estimates",
    'declined_estimates' => "Declined Estimates",
    'accepted_proposals' => "Accepted Quotes",
    'declined_proposals' => "Declined Quotes",
    'pending_projects' => "Pending Diligences",
    ...
    'unstar_project' => "Unstar Diligence",
    'star_task' => "Star Task",
